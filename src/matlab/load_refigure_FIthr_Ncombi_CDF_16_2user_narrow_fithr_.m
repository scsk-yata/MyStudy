...
load('Data_FI_Thr_Ncombi_CDF_data_8-2user_narrow')
    ...
    plot(Fairness_Index_proposed_16, Throughput_proposed_16,'>','Linewidth',3,'MarkerSize',20)
    hold on
    plot(Fairness_Index_proposed_16narrow, Throughput_proposed_16narrow,'>','Linewidth',3,'MarkerSize',20)
    hold on
