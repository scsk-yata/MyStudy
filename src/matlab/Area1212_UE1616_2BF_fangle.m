...
ca1 = [5,16,26,35,43,50,56,7,18,28,37,45,6,17,27,36,44,51];
carf1 = ones(N_RB,1) * ca1;
carf1 = repmat(carf1,1,18);

ca2 = [5,16,26,35,43,50,56,7,18,28,37,45,6,17,27,36,44,51];
carf2 = ones(N_RB,1) * [ca2,circshift(ca2,1),circshift(ca2,2),circshift(ca2,3),circshift(ca2,4),circshift(ca2,5)...
    ,circshift(ca2,6),circshift(ca2,7),circshift(ca2,8),circshift(ca2,9),circshift(ca2,10),circshift(ca2,11)...
    ,circshift(ca2,12),circshift(ca2,13),circshift(ca2,14),circshift(ca2,15),circshift(ca2,16),circshift(ca2,17)];
...
%{
save( [file_name,'/Data3_',num2str(trial),'trial'],'AC1','AC2','area_user','c1rf','c1rfce','c1rfco','c1rfp','c2rf','c2rfce','c2rfco','c2rfp'...
    ,'carf1','carf2','cumulative_throughput','cumulative_throughput_con','cumulative_throughput_pro','d_tu','hor_tu','PL_dB_tu','power_uuk_all'...
    ,'u2a','UC1','UC1ce','UC2','UC2co')
%}
save( [file_name,'/Dataf6_',num2str(trial),'trial'],'AC1','AC2','area_user','c1rf','c1rfce','c1rfco','c1rfpo','c1rfpe','c2rf','c2rfce','c2rfco','c2rfpo','c2rfpe'...
    ,'carf1','carf2','cumulative_throughput','cumulative_throughput_con','cumulative_throughput_pro','d_tu','hor_tu','PL_dB_tu','power_uuk_all'...
    ,'u2a','UC1','UC1ce','UC1pe','UC2','UC2co','UC2po')
if trial == N_trial
save( [file_name,'/Dataf6_',num2str(trial),'trial'],'AC1','AC2','area_user','c1rf','c1rfce','c1rfco','c1rfpo','c1rfpe','c2rf','c2rfce','c2rfco','c2rfpo','c2rfpe'...
