...
file_name = ['Result_',num2str(N_area),'_',num2str(Nu_TP1),num2str(Nu_TP1),'_',num2str(2),'_',num2str(3000),'trial_CDL-D'];
...
a2apsc(u2a(UC1ce(c1rfce(r,f),i1)),u2a(aul(aul~=0))) = a2apsc(u2a(UC1ce(c1rfce(r,f),i1)),u2a(aul(aul~=0))) + power_uuk_all(UC1ce(c1rfce(r,f),i1),aul(aul~=0),N_subcar_1RB*(r-1)+k);
a2apsc(u2a(aul(aul~=0)),u2a(UC1ce(c1rfce(r,f),i1))) = a2apsc(u2a(aul(aul~=0)),u2a(UC1ce(c1rfce(r,f),i1))) + power_uuk_all(aul(aul~=0),UC1ce(c1rfce(r,f),i1),N_subcar_1RB*(r-1)+k);
                end
