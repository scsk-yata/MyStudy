%% ２基地局平行設置 28-1616-2 allocationで一様にユーザを分布させた場合　送信範囲四角形の場合
clear
clc
rng('shuffle');
...
area_boundary = [0,atand(4/N_area_1TP),atand(2*4/N_area_1TP),atand(3*4/N_area_1TP),90-atand(3*4/N_area_1TP),90-atand(2*4/N_area_1TP),90-atand(4/N_area_1TP)...
    ,90,90+atand(4/N_area_1TP),90+atand(2*4/N_area_1TP),90+atand(3*4/N_area_1TP),180-atand(3*4/N_area_1TP),180-atand(2*4/N_area_1TP),180-atand(4/N_area_1TP),180];
...
%
ca1 = [6,19,31,42,52,61,69,76,8,21,33,44,54,63,7,20,32,43,53,62,70];
carf1 = ones(N_RB,1) * ca1;
carf1 = repmat(carf1,1,21);

ca2 = [6,19,31,42,52,61,69,76,8,21,33,44,54,63,7,20,32,43,53,62,70];
carf2 = ones(N_RB,1) * [ca2,circshift(ca2,1),circshift(ca2,2),circshift(ca2,3),circshift(ca2,4),circshift(ca2,5)...
    ...
    ,circshift(ca2,18),circshift(ca2,19),circshift(ca2,20)];
