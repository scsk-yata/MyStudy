...
%{
ca1 = [6,21,35,48,60,71,80,89,97,104,110,11,26,40,53,65];
carf1 = ones(N_RB,1) * ca1;
carf1 = repmat(carf1,1,24);
...
%}
save( [file_name,'/All_Data_',num2str(trial),'trial'],'area_user','cumulative_throughput','cumulative_throughput_con','cumulative_throughput_pro','a2aps','a2apsc','a2apsp')
if trial == N_trial
    save( [file_name,'/All_Data_',num2str(trial),'trial'],'area_user','cumulative_throughput','cumulative_throughput_con','cumulative_throughput_pro','total_comb','cumulative_throughput_ut','cumulative_throughput_utc','cumulative_throughput_utp','total_comb_con','total_comb_pro','a2aps','a2apsc','a2apsp')
end
