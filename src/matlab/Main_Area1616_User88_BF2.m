...
%% 希望信号電力と干渉信号電力
    ...
    R_signal19 = sum( (reshape(H_1uak(17,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal29 = sum( (reshape(H_2uak(17,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal110 = sum( (reshape(H_1uak(18,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal210 = sum( (reshape(H_2uak(18,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal111 = sum( (reshape(H_1uak(19,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal211 = sum( (reshape(H_2uak(19,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal112 = sum( (reshape(H_1uak(20,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal212 = sum( (reshape(H_2uak(20,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal113 = sum( (reshape(H_1uak(21,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal213 = sum( (reshape(H_2uak(21,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal114 = sum( (reshape(H_1uak(22,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal214 = sum( (reshape(H_2uak(22,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal115 = sum( (reshape(H_1uak(23,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal215 = sum( (reshape(H_2uak(23,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal116 = sum( (reshape(H_1uak(24,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal216 = sum( (reshape(H_2uak(24,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    %{
