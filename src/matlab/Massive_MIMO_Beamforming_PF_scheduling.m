...
P_tul = zeros(N_BS,Nu_all,N_beam);
...
reshape(H_uak(1,:,k),N_hor*N_ver,1).*a11 *ones(1,N_beam))  .*W_ab  .*Amp_ak
...
for u1 = 1:Nu_BS2
    for u2 = 1:Nu_BS2
        power_uuk2(u1,u2,k) = P_tul(2,u1+Nu_BS1,b(u2+Nu_BS1,k) );
        power_uuk_all(u1+Nu_BS1,u2+Nu_BS1,k) = P_tul(2,u1+Nu_BS1,b(u2+Nu_BS1,k));
    end
end

for u1 = 1:Nu_BS1
    for u2 = 1:Nu_BS2
        power_uuk_all(u1,u2+Nu_BS1,k) = P_tul(2,u1,b(u2+Nu_BS1,k));
        power_uuk_all(u2+Nu_BS1,u1,k) = P_tul(1,u2+Nu_BS1,b(u1,k));
    end
end
...
+ P_tul(2,UC1(c1rf(r,f),1),b(UC2(c2rf(r,f),1))) + P_tul(2,UC1(c1rf(r,f),1),b(UC2(c2rf(r,f),2))) + Noise_variance) );
...
+ P_tul(2,UC1(c1rf(r,f),2),b(UC2(c2rf(r,f),1))) + P_tul(2,UC1(c1rf(r,f),2),b(UC2(c2rf(r,f),2))) + Noise_variance) );
...
+ P_tul(1,UC2(c2rf(r,f),1),b(UC1(c1rf(r,f),1))) + P_tul(1,UC2(c2rf(r,f),1),b(UC1(c1rf(r,f),2))) + Noise_variance) );
...
+ P_tul(1,UC2(c2rf(r,f),2),b(UC1(c1rf(r,f),1))) + P_tul(1,UC2(c2rf(r,f),2),b(UC1(c1rf(r,f),2))) + Noise_variance) );
