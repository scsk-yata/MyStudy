%% ２基地局平行設置 20-1616-1 allocationで一様にユーザを分布させた場合　送信範囲四角形の場合
clear
clc
rng('shuffle');
...
file_name = ['Result_',num2str(N_area),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial+1000),'trial_AWGN'];
%file_name = ['Result_',num2str(N_area),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_CDL-D'];
save( [file_name,'/cumulative_throughput_',num2str(trial+1000),'trial'] , 'cumulative_throughput', 'cumulative_throughput_con','cumulative_throughput_pro','total_comb','total_comb_con','total_comb_pro','nua','mua1','mua2' )
