...
% 提案法のためのユーザ分け
user1pe = find(hor_1all < area_boundary(13));
user2po = find(hor_2all > area_boundary(1));
...
%}
save( [file_name,'/Dataf13_',num2str(trial),'trial'],'AC1','AC2','area_user','c1rf','c1rfce','c1rfco','c1rfpo','c1rfpe','c2rf','c2rfce','c2rfco','c2rfpo','c2rfpe'...
    ,'carf1','carf2','cumulative_throughput','cumulative_throughput_con','cumulative_throughput_pro','d_tu','hor_tu','PL_dB_tu','power_uuk_all'...
