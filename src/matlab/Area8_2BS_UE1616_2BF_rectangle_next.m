...
area_boundary = [0,atand(4/N_area_1TP),45,90-atand(4/N_area_1TP)...
    ,90,90+atand(4/N_area_1TP),135,180-atand(4/N_area_1TP),180];
...
%
ca1 = [1,8,14,19,23,26,28,7];
carf1 = ones(N_RB,1) * ca1;
carf1 = repmat(carf1,1,16);

ca2 = [1,8,14,19,23,26,28,7];
carf2 = ones(N_RB,1) * [ca2,circshift(ca2,1),circshift(ca2,2),circshift(ca2,3),circshift(ca2,4),circshift(ca2,5),circshift(ca2,6),circshift(ca2,7)];
...
%{
ca1 = [2,9,15,20,24,27,6,13];
carf1 = ones(N_RB,1) * ca1;
carf1 = repmat(carf1,1,16);

ca2 = [2,9,15,20,24,27,6,13];
carf2 = ones(N_RB,1) * [ca2,circshift(ca2,1),circshift(ca2,2),circshift(ca2,3),circshift(ca2,4),circshift(ca2,5),circshift(ca2,6),circshift(ca2,7)];
carf2 = repmat(carf2,1,2);
...
for c1 = 1:nnz3
    for c2 = 1:(Nu_TP1-nnz3-nnz4)
      ...
      %% 実際の値
        [throughput_sc_1,throughput_sc_2,throughput_sc_3,throughput_sc_4] = calculate_throughput_4user(power_uuk_all, noise_variance_dBm, rb, user_irf(1,rb,subframe),user_irf(2,rb,subframe),user_irf(3,rb,subframe),user_irf(4,rb,subframe));
...
log2( 1 + power_uuk_all(user_irf(1,r,f),user_irf(1,r,f),N_subcar_1RB*(r-1)+k)/(power_uuk_all(user_irf(1,r,f),user_irf(2,r,f),N_subcar_1RB*(r-1)+k)...
+ power_uuk_all(user_irf(1,r,f),user_irf(3,r,f),N_subcar_1RB*(r-1)+k) + power_uuk_all(user_irf(1,r,f),user_irf(4,r,f),N_subcar_1RB*(r-1)+k) + Npw) );

cumulative_throughput_utp(user_irf(2,r,f),trial) = cumulative_throughput_utp(user_irf(2,r,f),trial) + ...
log2( 1 + power_uuk_all(user_irf(2,r,f),user_irf(2,r,f),N_subcar_1RB*(r-1)+k)/(power_uuk_all(user_irf(2,r,f),user_irf(1,r,f),N_subcar_1RB*(r-1)+k)...
+ power_uuk_all(user_irf(2,r,f),user_irf(3,r,f),N_subcar_1RB*(r-1)+k) + power_uuk_all(user_irf(2,r,f),user_irf(4,r,f),N_subcar_1RB*(r-1)+k) + Npw) );

cumulative_throughput_utp(user_irf(3,r,f),trial) = cumulative_throughput_utp(user_irf(3,r,f),trial) + ...
log2( 1 + power_uuk_all(user_irf(3,r,f),user_irf(3,r,f),N_subcar_1RB*(r-1)+k)/(power_uuk_all(user_irf(3,r,f),user_irf(4,r,f),N_subcar_1RB*(r-1)+k)...
+ power_uuk_all(user_irf(3,r,f),user_irf(1,r,f),N_subcar_1RB*(r-1)+k) + power_uuk_all(user_irf(3,r,f),user_irf(2,r,f),N_subcar_1RB*(r-1)+k) + Npw) );

cumulative_throughput_utp(user_irf(4,r,f),trial) = cumulative_throughput_utp(user_irf(4,r,f),trial) + ...
log2( 1 + power_uuk_all(user_irf(4,r,f),user_irf(4,r,f),N_subcar_1RB*(r-1)+k)/(power_uuk_all(user_irf(4,r,f),user_irf(3,r,f),N_subcar_1RB*(r-1)+k)...
+ power_uuk_all(user_irf(4,r,f),user_irf(1,r,f),N_subcar_1RB*(r-1)+k) + power_uuk_all(user_irf(4,r,f),user_irf(2,r,f),N_subcar_1RB*(r-1)+k) + Npw) );
...
file_name = ['Result_',num2str(N_area),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_next'];
