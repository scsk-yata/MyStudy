...
save( [file_name,'/cumulative_throughput_',num2str(trial),'trial'] , 'cumulative_throughput', 'cumulative_throughput_con','cumulative_throughput_pro', 'cumulative_throughput_I0', 'cumulative_throughput_con_I0', 'cumulative_throughput_pro_I0','a2aps','a2apsc','a2apsp')
