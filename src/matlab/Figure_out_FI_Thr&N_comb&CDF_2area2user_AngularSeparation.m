...
for tr = 1:N_trial
    ...
    load( ['Result_',num2str(N_area_1TP),num2str(N_area_1TP),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial'...
        '/Workspace_Data_',num2str(tr),'trial_narrow'] , 'cumulative_throughput' )
    %{
...
load( ['Result_',num2str(N_area_1TP),num2str(N_area_1TP),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial'...
        '/Workspace_Data_',num2str(N_trial),'trial_narrow'] , 'cumulative_throughput_ut','total_comb' )
...
for tr = 1:N_trial
    ...
    %
    load( ['Result_',num2str(N_area_1TP),num2str(N_area_1TP),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial'...
        '/Workspace_Data_',num2str(tr),'trial_narrow'] , 'cumulative_throughput_con' )
    %{
    load( ['Result_',num2str(N_area_1TP),num2str(N_area_1TP),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_narrow'...
...
load( ['Result_',num2str(N_area_1TP),num2str(N_area_1TP),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial'...
        '/Workspace_Data_',num2str(N_trial),'trial_narrow'] , 'cumulative_throughput_utc','total_comb_con' )
...
for tr = 1:N_trial
    ...
    load( ['Result_1212_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial'...
        '/Workspace_Data_',num2str(tr),'trial_narrow'] , 'cumulative_throughput_pro' )
    %{
...
load( ['Result_1212_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial'...
        '/Workspace_Data_',num2str(N_trial),'trial_narrow'] , 'cumulative_throughput_utp','total_comb_pro' )

N_subframe = length(cumulative_throughput_pro)
seq_ctp12narrow = reshape(cumulative_throughput_utp,1,Nu_all*N_trial);
...
N_subframe = length(cumulative_throughput_pro)
seq_ctp16narrow = reshape(cumulative_throughput_utp,1,Nu_all*N_trial);
...
load( ['Result_1212_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial'...
        '/Workspace_Data_',num2str(N_trial),'trial'] , 'cumulative_throughput_utp','total_comb_pro' )
...
%%
   ...
   legend({'比較手法','従来手法','提案手法（分割エリア数12，エリアの間隔を狭めた場合）','提案手法（分割エリア数16，エリアの間隔を狭めた場合）'...
       ,'提案手法（分割エリア数１２）','提案手法（分割エリア数１６）'},'Location','northwest','FontSize',20)
   %{
...
legend({'比較手法','従来手法','提案手法（分割エリア数 12，エリアの間隔を狭めた場合）','提案手法（分割エリア数 16，エリアの間隔を狭めた場合）'...
       ,'提案手法（分割エリア数 12）','提案手法（分割エリア数 16）'},'Location','northwest','FontSize',20)
