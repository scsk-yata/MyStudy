...
file_name = ['Result_',num2str(N_area_1TP),num2str(N_area_1TP),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_narrow'];
%{
...
%}
save( [file_name,'/All_Data_',num2str(trial),'trial_narrow'],'area_user','cumulative_throughput','cumulative_throughput_con','cumulative_throughput_pro'...
