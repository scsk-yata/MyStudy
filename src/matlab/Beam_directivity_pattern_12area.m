...
%
load(['CDL_channel_24/CDL_channel_matrix.mat'] ,'H_1uak','H_2uak','PL_dB_tu' )
%}
%% 各受信端末の基地局から見た距離
...
for u = Na_1TP+1:2*Na_1TP
    hor_tu(2,u) = 15*(u-1-Na_1TP)+15*1/2;
...
%% 希望信号電力と干渉信号電力
    ...
    b(13,k) = find( P_tubk(2,13,:,k) == max(P_tubk(2,13,:,k)) ,1 );
    b(14,k) = find( P_tubk(2,14,:,k) == max(P_tubk(2,14,:,k)) ,1 );
    b(15,k) = find( P_tubk(2,15,:,k) == max(P_tubk(2,15,:,k)) ,1 );
    b(16,k) = find( P_tubk(2,16,:,k) == max(P_tubk(2,16,:,k)) ,1 );
...
for c12 = 1:length(UC12)
    throughput_UC12(c12) = log2( 1 + power_uuk_all(UC12(c12,1),UC12(c12,1),subcar_index)/(power_uuk_all(UC12(c12,1),UC12(c12,2),subcar_index) + Npw) )...
        + log2( 1 + power_uuk_all(UC12(c12,2),UC12(c12,2),subcar_index)/(power_uuk_all(UC12(c12,2),UC12(c12,1),subcar_index) + Npw) );
end
...
%%
Rx_power_directivity11k = zeros(Nu_1TP,N_beam,N_subcar);
Rx_power_directivity21k = zeros(Nu_1TP,N_beam,N_subcar);
Rx_power_directivity12k = zeros(Nu_1TP,N_beam,N_subcar);

for u = 1:Na_1TP
    for k = 1:N_subcar
    Rx_power_directivity11k(u,:,k) = P_tubk(1,u,:,k);
    Rx_power_directivity21k(u,:,k) = P_tubk(2,u,:,k);
    Rx_power_directivity12k(u,:,k) = P_tubk(1,u+Na_1TP,:,k);

    Rx_power_directivity11k(u,:,k) = Rx_power_directivity11k(u,:,k)/max(Rx_power_directivity11k(u,:,k));
    Rx_power_directivity21k(u,:,k) = Rx_power_directivity21k(u,:,k)/max(Rx_power_directivity11k(u,:,k));
    Rx_power_directivity12k(u,:,k) = Rx_power_directivity12k(u,:,k)/max(Rx_power_directivity11k(u,:,k));
    end
end

Rx_power_directivity11k_dB = 10*log10(Rx_power_directivity11k);
Rx_power_directivity21k_dB = 10*log10(Rx_power_directivity21k);
Rx_power_directivity12k_dB = 10*log10(Rx_power_directivity12k);

Rx_power_directivity111_dB = Rx_power_directivity11k_dB(1,:,subcar_index);
Rx_power_directivity112_dB = Rx_power_directivity11k_dB(2,:,subcar_index);
Rx_power_directivity113_dB = Rx_power_directivity11k_dB(3,:,subcar_index);
Rx_power_directivity114_dB = Rx_power_directivity11k_dB(4,:,subcar_index);
Rx_power_directivity115_dB = Rx_power_directivity11k_dB(5,:,subcar_index);
Rx_power_directivity116_dB = Rx_power_directivity11k_dB(6,:,subcar_index);
Rx_power_directivity117_dB = Rx_power_directivity11k_dB(7,:,subcar_index);
Rx_power_directivity118_dB = Rx_power_directivity11k_dB(8,:,subcar_index);
Rx_power_directivity119_dB = Rx_power_directivity11k_dB(9,:,subcar_index);
Rx_power_directivity1110_dB = Rx_power_directivity11k_dB(10,:,subcar_index);
Rx_power_directivity1111_dB = Rx_power_directivity11k_dB(11,:,subcar_index);
Rx_power_directivity1112_dB = Rx_power_directivity11k_dB(12,:,subcar_index);

Rx_power_directivity121_dB = Rx_power_directivity12k_dB(1,:,subcar_index);
Rx_power_directivity122_dB = Rx_power_directivity12k_dB(2,:,subcar_index);
Rx_power_directivity123_dB = Rx_power_directivity12k_dB(3,:,subcar_index);
Rx_power_directivity124_dB = Rx_power_directivity12k_dB(4,:,subcar_index);
Rx_power_directivity125_dB = Rx_power_directivity12k_dB(5,:,subcar_index);
Rx_power_directivity126_dB = Rx_power_directivity12k_dB(6,:,subcar_index);
Rx_power_directivity127_dB = Rx_power_directivity12k_dB(7,:,subcar_index);
Rx_power_directivity128_dB = Rx_power_directivity12k_dB(8,:,subcar_index);
Rx_power_directivity129_dB = Rx_power_directivity12k_dB(9,:,subcar_index);
Rx_power_directivity1210_dB = Rx_power_directivity12k_dB(10,:,subcar_index);
Rx_power_directivity1211_dB = Rx_power_directivity12k_dB(11,:,subcar_index);
Rx_power_directivity1212_dB = Rx_power_directivity12k_dB(12,:,subcar_index);

%{
save(['CDL_channel_24/CDL_channel_matrix.mat'] ,'H_1uak','H_2uak','PL_dB_tu' )
%}

%% figure

Power_u2u = power_uuk_all(:,:,subcar_index);
...
%% ユーザかビーム固定
figure
plot(anglerange_hor, Rx_power_directivity111_dB)
hold on
plot(anglerange_hor, Rx_power_directivity121_dB)
...
figure
plot(anglerange_hor, Rx_power_directivity112_dB)
hold on
plot(anglerange_hor, Rx_power_directivity122_dB)
...
figure
plot(anglerange_hor, Rx_power_directivity113_dB)
hold on
plot(anglerange_hor, Rx_power_directivity123_dB)
...
figure
plot(anglerange_hor, Rx_power_directivity114_dB)
hold on
plot(anglerange_hor, Rx_power_directivity124_dB)
...
figure
plot(anglerange_hor, Rx_power_directivity115_dB)
hold on
plot(anglerange_hor, Rx_power_directivity125_dB)
...
figure
plot(anglerange_hor, Rx_power_directivity116_dB)
hold on
plot(anglerange_hor, Rx_power_directivity126_dB)
...
%%
figure
plot(anglerange_hor, Rx_power_directivity117_dB)
hold on
plot(anglerange_hor, Rx_power_directivity127_dB)
...
figure
plot(anglerange_hor, Rx_power_directivity118_dB)
hold on
plot(anglerange_hor, Rx_power_directivity128_dB)
...
figure
plot(anglerange_hor, Rx_power_directivity119_dB)
hold on
plot(anglerange_hor, Rx_power_directivity129_dB)
...
figure
plot(anglerange_hor, Rx_power_directivity1110_dB)
hold on
plot(anglerange_hor, Rx_power_directivity1210_dB)
...
figure
plot(anglerange_hor, Rx_power_directivity1111_dB)
hold on
plot(anglerange_hor, Rx_power_directivity1211_dB)
...
figure
plot(anglerange_hor, Rx_power_directivity1112_dB)
hold on
plot(anglerange_hor, Rx_power_directivity1212_dB)
