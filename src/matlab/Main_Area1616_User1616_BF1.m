...
N_TP = 2;
Nu_1RB = 1;
Nu_TP1 = 16;                                    % 左側の基地局の送信範囲ユーザ数
Nu_TP2 = 16;                                    % 右側の基地局の送信範囲ユーザ数
...
carf = ones(N_RB,1) * [1:17:256,2:17:240,241,3:17:224,225,242,4:17:208,209:17:243,5:17:192,193:17:244,6:17:176,177:17:245,7:17:160,161:17:246,8:17:144,145:17:247 ...
    9:17:128,129:17:248,10:17:112,113:17:249,11:17:96,97:17:250,12:17:80,81:17:251,13:17:64,65:17:252,14:17:48,49:17:253,15,32,33:17:254,16,17:17:255];
...
save( [file_name,'/Workspace_Data_',num2str(trial),'trial'] , 'cumulative_throughput', 'cumulative_throughput_con','cumulative_throughput_pro', 'cumulative_throughput_I0', 'cumulative_throughput_con_I0', 'cumulative_throughput_pro_I0','a2aps','a2apsc','a2apsp','area_user')

if trial == N_trial
save( [file_name,'/Workspace_Data_',num2str(trial),'trial'] , 'cumulative_throughput', 'cumulative_throughput_con','cumulative_throughput_pro', 'cumulative_throughput_I0', 'cumulative_throughput_con_I0', 'cumulative_throughput_pro_I0','total_comb','total_comb_con','total_comb_pro','a2aps','a2apsc','a2apsp','area_user'...
