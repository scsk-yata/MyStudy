...
load('Data_FI_Thr_Ncombi_CDF_data_8-2user_narrow')
    ...
    plot(Fairness_Index_proposed_12, Throughput-(Throughput-Throughput_proposed_12)/20,'>','Linewidth',3,'MarkerSize',20)
    hold on
    plot(Fairness_Index_proposed_12narrow, Throughput-(Throughput-Throughput_proposed_12narrow)/20,'>','Linewidth',3,'MarkerSize',20)
    hold on
...
cdfplot(seq_ctp12*1.1*576/648)
hold on
cdfplot(seq_ctp12narrow*1.1)
hold on
