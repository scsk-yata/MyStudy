...
% 提案法のためのユーザ分け
user1pe = find(hor_1all < area_boundary(10));
user2po = find(hor_2all > area_boundary(4));
user2po = user2po + Nu_TP1;
...
for u1 = 1:Nu_TP2
    for u2 = 1:Nu_TP2
        power_uuk2(u1,u2,k) = P_tubk(2,u1+Nu_TP1,b(u2+Nu_TP1,k),k);
        power_uuk_all(u1+Nu_TP1,u2+Nu_TP1,k) = P_tubk(2,u1+Nu_TP1,b(u2+Nu_TP1,k),k);
    end
end
...
for u1 = 1:Nu_TP1
    for u2 = 1:Nu_TP2
        ...
        power_uuk_all(u1,u2+Nu_TP1,k) = P_tubk(2,u1,b(u2+Nu_TP1,k),k);
        power_uuk_all(u2+Nu_TP1,u1,k) = P_tubk(1,u2+Nu_TP1,b(u1,k),k);
...
log2( 1 + P_tubk(1,UC1(c1rf(r,f),1),b(UC1(c1rf(r,f),1),k),k)/(P_tubk(1,UC1(c1rf(r,f),1),b(UC1(c1rf(r,f),2),k),k)...
+ P_tubk(2,UC1(c1rf(r,f),1),b(UC2(c2rf(r,f),1),k),k) + P_tubk(2,UC1(c1rf(r,f),1),b(UC2(c2rf(r,f),2),k),k) + Npw) );
          
cumulative_throughput_ut(UC1(c1rf(r,f),2),trial) = cumulative_throughput_ut(UC1(c1rf(r,f),2),trial) + ...
log2( 1 + P_tubk(1,UC1(c1rf(r,f),2),b(UC1(c1rf(r,f),2),k),k)/(P_tubk(1,UC1(c1rf(r,f),2),b(UC1(c1rf(r,f),1),k),k)...
+ P_tubk(2,UC1(c1rf(r,f),2),b(UC2(c2rf(r,f),1),k),k) + P_tubk(2,UC1(c1rf(r,f),2),b(UC2(c2rf(r,f),2),k),k) + Npw) );
          
cumulative_throughput_ut(UC2(c2rf(r,f),1),trial) = cumulative_throughput_ut(UC2(c2rf(r,f),1),trial) + ...
log2( 1 + P_tubk(2,UC2(c2rf(r,f),1),b(UC2(c2rf(r,f),1),k),k)/(P_tubk(2,UC2(c2rf(r,f),1),b(UC2(c2rf(r,f),2),k),k)...
+ P_tubk(1,UC2(c2rf(r,f),1),b(UC1(c1rf(r,f),1),k),k) + P_tubk(1,UC2(c2rf(r,f),1),b(UC1(c1rf(r,f),2),k),k) + Npw) );

cumulative_throughput_ut(UC2(c2rf(r,f),2),trial) = cumulative_throughput_ut(UC2(c2rf(r,f),2),trial) + ...
log2( 1 + P_tubk(2,UC2(c2rf(r,f),2),b(UC2(c2rf(r,f),2),k),k)/(P_tubk(2,UC2(c2rf(r,f),2),b(UC2(c2rf(r,f),1),k),k)...
+ P_tubk(1,UC2(c2rf(r,f),2),b(UC1(c1rf(r,f),1),k),k) + P_tubk(1,UC2(c2rf(r,f),2),b(UC1(c1rf(r,f),2),k),k) + Npw) );
...
log2( 1 + P_tubk(1,UC1(c1rfco(r,f),1),b(UC1(c1rfco(r,f),1),k),k)/(P_tubk(1,UC1(c1rfco(r,f),1),b(UC1(c1rfco(r,f),2),k),k)...
+ P_tubk(2,UC1(c1rfco(r,f),1),b(UC2co(c2rfco(r,f),1),k),k) + P_tubk(2,UC1(c1rfco(r,f),1),b(UC2co(c2rfco(r,f),2),k),k) + Npw) );
          
cumulative_throughput_utc(UC1(c1rfco(r,f),2),trial) = cumulative_throughput_utc(UC1(c1rfco(r,f),2),trial) + ...
log2( 1 + P_tubk(1,UC1(c1rfco(r,f),2),b(UC1(c1rfco(r,f),2),k),k)/(P_tubk(1,UC1(c1rfco(r,f),2),b(UC1(c1rfco(r,f),1),k),k)...
+ P_tubk(2,UC1(c1rfco(r,f),2),b(UC2co(c2rfco(r,f),1),k),k) + P_tubk(2,UC1(c1rfco(r,f),2),b(UC2co(c2rfco(r,f),2),k),k) + Npw) );

cumulative_throughput_utc(UC2co(c2rfco(r,f),1),trial) = cumulative_throughput_utc(UC2co(c2rfco(r,f),1),trial) + ...
log2( 1 + P_tubk(2,UC2co(c2rfco(r,f),1),b(UC2co(c2rfco(r,f),1),k),k)/(P_tubk(2,UC2co(c2rfco(r,f),1),b(UC2co(c2rfco(r,f),2),k),k)...
+ P_tubk(1,UC2co(c2rfco(r,f),1),b(UC1(c1rfco(r,f),1),k),k) + P_tubk(1,UC2co(c2rfco(r,f),1),b(UC1(c1rfco(r,f),2),k),k) + Npw) );
          
cumulative_throughput_utc(UC2co(c2rfco(r,f),2),trial) = cumulative_throughput_utc(UC2co(c2rfco(r,f),2),trial) + ...
log2( 1 + P_tubk(2,UC2co(c2rfco(r,f),2),b(UC2co(c2rfco(r,f),2),k),k)/(P_tubk(2,UC2co(c2rfco(r,f),2),b(UC2co(c2rfco(r,f),1),k),k)...
+ P_tubk(1,UC2co(c2rfco(r,f),2),b(UC1(c1rfco(r,f),1),k),k) + P_tubk(1,UC2co(c2rfco(r,f),2),b(UC1(c1rfco(r,f),2),k),k) + Npw) );
...
cumulative_throughput_utc(UC1(c1rfco(r,f),1),trial) = cumulative_throughput_utc(UC1(c1rfco(r,f),1),trial) + ...
log2( 1 + P_tubk(1,UC1(c1rfco(r,f),1),b(UC1(c1rfco(r,f),1),k),k)/(P_tubk(1,UC1(c1rfco(r,f),1),b(UC1(c1rfco(r,f),2),k),k)...
+ P_tubk(2,UC1(c1rfco(r,f),1),b(right_user2,k),k) + Npw) );
          
cumulative_throughput_utc(UC1(c1rfco(r,f),2),trial) = cumulative_throughput_utc(UC1(c1rfco(r,f),2),trial) + ...
log2( 1 + P_tubk(1,UC1(c1rfco(r,f),2),b(UC1(c1rfco(r,f),2),k),k)/(P_tubk(1,UC1(c1rfco(r,f),2),b(UC1(c1rfco(r,f),1),k),k)...
+ P_tubk(2,UC1(c1rfco(r,f),2),b(right_user2,k),k) + Npw) );

cumulative_throughput_utc(right_user2,trial) = cumulative_throughput_utc(right_user2,trial) + ...
log2( 1 + P_tubk(2,right_user2,b(right_user2,k),k)/(P_tubk(1,right_user2,b(UC1(c1rfco(r,f),1),k),k) + P_tubk(1,right_user2,b(UC1(c1rfco(r,f),2),k),k) + Npw) );
...
cumulative_throughput_utc(UC1(c1rfco(r,f),1),trial) = cumulative_throughput_utc(UC1(c1rfco(r,f),1),trial) + ...
log2( 1 + P_tubk(1,UC1(c1rfco(r,f),1),b(UC1(c1rfco(r,f),1),k),k)/Npw );

cumulative_throughput_utc(UC1(c1rfco(r,f),2),trial) = cumulative_throughput_utc(UC1(c1rfco(r,f),2),trial) + ...
log2( 1 + P_tubk(1,UC1(c1rfco(r,f),2),b(UC1(c1rfco(r,f),2),k),k)/Npw );
...
log2( 1 + P_tubk(1,UC1ce(c1rfce(r,f),1),b(UC1ce(c1rfce(r,f),1),k),k)/(P_tubk(1,UC1ce(c1rfce(r,f),1),b(UC1ce(c1rfce(r,f),2),k),k)...
+ P_tubk(2,UC1ce(c1rfce(r,f),1),b(UC2(c2rfce(r,f),1),k),k) + P_tubk(2,UC1ce(c1rfce(r,f),1),b(UC2(c2rfce(r,f),2),k),k) + Npw) );
          
cumulative_throughput_utc(UC1ce(c1rfce(r,f),2),trial) = cumulative_throughput_utc(UC1ce(c1rfce(r,f),2),trial) + ...
log2( 1 + P_tubk(1,UC1ce(c1rfce(r,f),2),b(UC1ce(c1rfce(r,f),2),k),k)/(P_tubk(1,UC1ce(c1rfce(r,f),2),b(UC1ce(c1rfce(r,f),1),k),k)...
+ P_tubk(2,UC1ce(c1rfce(r,f),2),b(UC2(c2rfce(r,f),1),k),k) + P_tubk(2,UC1ce(c1rfce(r,f),2),b(UC2(c2rfce(r,f),2),k),k) + Npw) );

cumulative_throughput_utc(UC2(c2rfce(r,f),1),trial) = cumulative_throughput_utc(UC2(c2rfce(r,f),1),trial) + ...
log2( 1 + P_tubk(2,UC2(c2rfce(r,f),1),b(UC2(c2rfce(r,f),1),k),k)/(P_tubk(2,UC2(c2rfce(r,f),1),b(UC2(c2rfce(r,f),2),k),k)...
+ P_tubk(1,UC2(c2rfce(r,f),1),b(UC1ce(c1rfce(r,f),1),k),k) + P_tubk(1,UC2(c2rfce(r,f),1),b(UC1ce(c1rfce(r,f),2),k),k) + Npw) );
          
cumulative_throughput_utc(UC2(c2rfce(r,f),2),trial) = cumulative_throughput_utc(UC2(c2rfce(r,f),2),trial) + ...
log2( 1 + P_tubk(2,UC2(c2rfce(r,f),2),b(UC2(c2rfce(r,f),2),k),k)/(P_tubk(2,UC2(c2rfce(r,f),2),b(UC2(c2rfce(r,f),1),k),k)...
+ P_tubk(1,UC2(c2rfce(r,f),2),b(UC1ce(c1rfce(r,f),1),k),k) + P_tubk(1,UC2(c2rfce(r,f),2),b(UC1ce(c1rfce(r,f),2),k),k) + Npw) );
...
log2( 1 + P_tubk(1,left_user1,b(left_user1,k),k)/(P_tubk(2,left_user1,b(UC2(c2rfce(r,f),1),k),k) + P_tubk(2,left_user1,b(UC2(c2rfce(r,f),2),k),k) + Npw) );

cumulative_throughput_utc(UC2(c2rfce(r,f),1),trial) = cumulative_throughput_utc(UC2(c2rfce(r,f),1),trial) + ...
log2( 1 + P_tubk(2,UC2(c2rfce(r,f),1),b(UC2(c2rfce(r,f),1),k),k)/(P_tubk(2,UC2(c2rfce(r,f),1),b(UC2(c2rfce(r,f),2),k),k)...
+ P_tubk(1,UC2(c2rfce(r,f),1),b(left_user1,k),k) + Npw) );
          
cumulative_throughput_utc(UC2(c2rfce(r,f),2),trial) = cumulative_throughput_utc(UC2(c2rfce(r,f),2),trial) + ...
log2( 1 + P_tubk(2,UC2(c2rfce(r,f),2),b(UC2(c2rfce(r,f),2),k),k)/(P_tubk(2,UC2(c2rfce(r,f),2),b(UC2(c2rfce(r,f),1),k),k)...
+ P_tubk(1,UC2(c2rfce(r,f),2),b(left_user1,k),k) + Npw) );
...
cumulative_throughput_utc(UC2(c2rfce(r,f),1),trial) = cumulative_throughput_utc(UC2(c2rfce(r,f),1),trial) + ...
log2( 1 + P_tubk(2,UC2(c2rfce(r,f),1),b(UC2(c2rfce(r,f),1),k),k)/Npw );

cumulative_throughput_utc(UC2(c2rfce(r,f),2),trial) = cumulative_throughput_utc(UC2(c2rfce(r,f),2),trial) + ...
log2( 1 + P_tubk(2,UC2(c2rfce(r,f),2),b(UC2(c2rfce(r,f),2),k),k)/Npw );
...
for f = 1:2:N_subframe-1
    for r = 1:N_RB
        ...
        if N_right2 > 1
            for k = 1:N_subcar_1RB
cumulative_throughput_utc(UC1(c1rfco(r,f),1),trial) = cumulative_throughput_utc(UC1(c1rfco(r,f),1),trial) + ...
log2( 1 + power_uuk_all(UC1(c1rfco(r,f),1),UC1(c1rfco(r,f),1),N_subcar_1RB*(r-1)+k)/(power_uuk_all(UC1(c1rfco(r,f),1),UC1(c1rfco(r,f),2),k)...
+ power_uuk_all(UC1(c1rfco(r,f),1),UC2co(c2rfco(r,f),1),N_subcar_1RB*(r-1)+k) + power_uuk_all(UC1(c1rfco(r,f),1),UC2co(c2rfco(r,f),2),k) + Npw) );
          
cumulative_throughput_utc(UC1(c1rfco(r,f),2),trial) = cumulative_throughput_utc(UC1(c1rfco(r,f),2),trial) + ...
log2( 1 + power_uuk_all(UC1(c1rfco(r,f),2),UC1(c1rfco(r,f),2),N_subcar_1RB*(r-1)+k)/(power_uuk_all(UC1(c1rfco(r,f),2),UC1(c1rfco(r,f),1),k)...
+ power_uuk_all(UC1(c1rfco(r,f),2),UC2co(c2rfco(r,f),1),N_subcar_1RB*(r-1)+k) + power_uuk_all(UC1(c1rfco(r,f),2),UC2co(c2rfco(r,f),2),k) + Npw) );

cumulative_throughput_utc(UC2co(c2rfco(r,f),1),trial) = cumulative_throughput_utc(UC2co(c2rfco(r,f),1),trial) + ...
log2( 1 + power_uuk_all(UC2co(c2rfco(r,f),1),UC2co(c2rfco(r,f),1),N_subcar_1RB*(r-1)+k)/(power_uuk_all(UC2co(c2rfco(r,f),1),UC2co(c2rfco(r,f),2),k)...
+ power_uuk_all(UC2co(c2rfco(r,f),1),UC1(c1rfco(r,f),1),N_subcar_1RB*(r-1)+k) + power_uuk_all(UC2co(c2rfco(r,f),1),UC1(c1rfco(r,f),2),k) + Npw) );
          
cumulative_throughput_utc(UC2co(c2rfco(r,f),2),trial) = cumulative_throughput_utc(UC2co(c2rfco(r,f),2),trial) + ...
log2( 1 + power_uuk_all(UC2co(c2rfco(r,f),2),UC2co(c2rfco(r,f),2),N_subcar_1RB*(r-1)+k)/(power_uuk_all(UC2co(c2rfco(r,f),2),UC2co(c2rfco(r,f),1),k)...
+ power_uuk_all(UC2co(c2rfco(r,f),2),UC1(c1rfco(r,f),1),N_subcar_1RB*(r-1)+k) + power_uuk_all(UC2co(c2rfco(r,f),2),UC1(c1rfco(r,f),2),k) + Npw) );
...
for subframe = 1:N_subframe
    ...
    for rb = 1:N_RB
        ...
        for UE_comb_index = 1:N_combinations_temp
            ...
            [throughput_est_sc_1, throughput_est_sc_2] = calculate_throughput_PF(power_uuk1, noise_variance_dBm, rb, c1rfpo(rb, subframe), combination_temp );
            ...
            elseif zero_judge == 0 && zero_user_num == 1
                ...
                for j = 1:Nu_1RB
                    if combination_temp(c1rfpo(rb, subframe), j) == zero_user
                        ...
                        ratio_now = ( throughput_EST_sc(j)) / (( cumulative_throughput_all(combination_temp(c1rfpo(rb, subframe), j)))/normalization_value);
                    end
                    ratio = ratio * ( 1 + ratio_now );
                end
            elseif zero_judge == 1
    ...
    %%
    for rb = 1:N_RB
        [throughput_sc_1, throughput_sc_2] = calculate_throughput_PF(power_uuk1, noise_variance_dBm, rb, c1rfpo(rb, subframe), combination);
        ...
        for j = 1:Nu_1RB
            cumulative_throughput_all(combination(c1rfpo(rb, subframe), j)) = cumulative_throughput_all(combination(c1rfpo(rb, subframe), j)) + throughput_sc(j);
        end
    end
...
for subframe = 1:N_subframe
    ...
    for rb = 1:N_RB
        ...
        for UE_comb_index = 1:N_combinations_temp
            ...
            [throughput_est_sc_1, throughput_est_sc_2] = calculate_throughput_PF(power_uuk2, noise_variance_dBm, rb, c2rfpe(rb, subframe), combination_temp );
            ...
            elseif zero_judge == 0 && zero_user_num == 1
                ...
                for j = 1:Nu_1RB
                    if combination_temp(c2rfpe(rb, subframe), j) == zero_user
                        ...
                        ratio_now = ( throughput_EST_sc(j)) / (( cumulative_throughput_all(combination_temp(c2rfpe(rb, subframe), j)+Nu_TP1))/normalization_value);
                    end
                    ratio = ratio * ( 1 + ratio_now );
                end
            elseif zero_judge == 1
    ...
    %%
    for rb = 1:N_RB
        [throughput_sc_1, throughput_sc_2] = calculate_throughput_PF(power_uuk2, noise_variance_dBm, rb, c2rfpe(rb, subframe), combination);
        
        throughput_sc(1) = sum(throughput_sc_1(:))/12; % subcarrier数で正規化
        throughput_sc(2) = sum(throughput_sc_2(:))/12; % subcarrier数で正規化
        
        for j = 1:Nu_1RB
            cumulative_throughput_all(UC2(c2rfpe(rb, subframe), j)) = cumulative_throughput_all(UC2(c2rfpe(rb, subframe), j)) + throughput_sc(j);
        end
    end
...
for f = 1:2:N_subframe-1
    for r = 1:N_RB
        ...
        if N_2po > 1
            for k = 1:N_subcar_1RB
cumulative_throughput_utp(UC1(c1rfpo(r,f),1),trial) = cumulative_throughput_utp(UC1(c1rfpo(r,f),1),trial) + ...
log2( 1 + power_uuk_all(UC1(c1rfpo(r,f),1),UC1(c1rfpo(r,f),1),N_subcar_1RB*(r-1)+k)/(power_uuk_all(UC1(c1rfpo(r,f),1),UC1(c1rfpo(r,f),2),N_subcar_1RB*(r-1)+k)...
+ power_uuk_all(UC1(c1rfpo(r,f),1),UC2po(c2rfpo(r,f),1),N_subcar_1RB*(r-1)+k) + power_uuk_all(UC1(c1rfpo(r,f),1),UC2po(c2rfpo(r,f),2),N_subcar_1RB*(r-1)+k) + Npw) );
          
cumulative_throughput_utp(UC1(c1rfpo(r,f),2),trial) = cumulative_throughput_utp(UC1(c1rfpo(r,f),2),trial) + ...
log2( 1 + power_uuk_all(UC1(c1rfpo(r,f),2),UC1(c1rfpo(r,f),2),N_subcar_1RB*(r-1)+k)/(power_uuk_all(UC1(c1rfpo(r,f),2),UC1(c1rfpo(r,f),1),N_subcar_1RB*(r-1)+k)...
+ power_uuk_all(UC1(c1rfpo(r,f),2),UC2po(c2rfpo(r,f),1),N_subcar_1RB*(r-1)+k) + power_uuk_all(UC1(c1rfpo(r,f),2),UC2po(c2rfpo(r,f),2),N_subcar_1RB*(r-1)+k) + Npw) );

cumulative_throughput_utp(UC2po(c2rfpo(r,f),1),trial) = cumulative_throughput_utp(UC2po(c2rfpo(r,f),1),trial) + ...
log2( 1 + power_uuk_all(UC2po(c2rfpo(r,f),1),UC2po(c2rfpo(r,f),1),N_subcar_1RB*(r-1)+k)/(power_uuk_all(UC2po(c2rfpo(r,f),1),UC2po(c2rfpo(r,f),2),N_subcar_1RB*(r-1)+k)...
+ power_uuk_all(UC2po(c2rfpo(r,f),1),UC1(c1rfpo(r,f),1),N_subcar_1RB*(r-1)+k) + power_uuk_all(UC2po(c2rfpo(r,f),1),UC1(c1rfpo(r,f),2),N_subcar_1RB*(r-1)+k) + Npw) );
          
cumulative_throughput_utp(UC2po(c2rfpo(r,f),2),trial) = cumulative_throughput_utp(UC2po(c2rfpo(r,f),2),trial) + ...
log2( 1 + power_uuk_all(UC2po(c2rfpo(r,f),2),UC2po(c2rfpo(r,f),2),N_subcar_1RB*(r-1)+k)/(power_uuk_all(UC2po(c2rfpo(r,f),2),UC2po(c2rfpo(r,f),1),N_subcar_1RB*(r-1)+k)...
+ power_uuk_all(UC2po(c2rfpo(r,f),2),UC1(c1rfpo(r,f),1),N_subcar_1RB*(r-1)+k) + power_uuk_all(UC2po(c2rfpo(r,f),2),UC1(c1rfpo(r,f),2),N_subcar_1RB*(r-1)+k) + Npw) );



cumulative_throughput_atp(u2a(UC1(c1rfpo(r,f),1)),trial) = cumulative_throughput_atp(u2a(UC1(c1rfpo(r,f),1)),trial) + ...
log2( 1 + power_uuk_all(UC1(c1rfpo(r,f),1),UC1(c1rfpo(r,f),1),N_subcar_1RB*(r-1)+k)/(power_uuk_all(UC1(c1rfpo(r,f),1),UC1(c1rfpo(r,f),2),N_subcar_1RB*(r-1)+k)...
+ power_uuk_all(UC1(c1rfpo(r,f),1),UC2po(c2rfpo(r,f),1),N_subcar_1RB*(r-1)+k) + power_uuk_all(UC1(c1rfpo(r,f),1),UC2po(c2rfpo(r,f),2),N_subcar_1RB*(r-1)+k) + Npw) );
          
cumulative_throughput_atp(u2a(UC1(c1rfpo(r,f),2)),trial) = cumulative_throughput_atp(u2a(UC1(c1rfpo(r,f),2)),trial) + ...
log2( 1 + power_uuk_all(UC1(c1rfpo(r,f),2),UC1(c1rfpo(r,f),2),N_subcar_1RB*(r-1)+k)/(power_uuk_all(UC1(c1rfpo(r,f),2),UC1(c1rfpo(r,f),1),N_subcar_1RB*(r-1)+k)...
+ power_uuk_all(UC1(c1rfpo(r,f),2),UC2po(c2rfpo(r,f),1),N_subcar_1RB*(r-1)+k) + power_uuk_all(UC1(c1rfpo(r,f),2),UC2po(c2rfpo(r,f),2),N_subcar_1RB*(r-1)+k) + Npw) );
...
+ power_uuk_all(UC2po(c2rfpo(r,f),2),UC1(c1rfpo(r,f),1),N_subcar_1RB*(r-1)+k) + power_uuk_all(UC2po(c2rfpo(r,f),2),UC1(c1rfpo(r,f),2),N_subcar_1RB*(r-1)+k) + Npw) );
        ...
        %% 実際の値
        [throughput_sc_1,throughput_sc_2,throughput_sc_3,throughput_sc_4] = calculate_throughput_4user(power_uuk_all, noise_variance_dBm, r, UC1(c1rfpo(r,f),1),UC1(c1rfpo(r,f),2),UC2po(c2rfpo(r,f),1),UC2po(c2rfpo(r,f),2));
        
        throughput_sc = zeros(1, Nu_1RB*2);   % 瞬時スループットに相当する
        
        throughput_sc(1) = sum(throughput_sc_1(:))/12; % subcarrier数で正規化
        cumulative_throughput_pro(UC1(c1rfpo(r,f),1), f) = cumulative_throughput_pro(UC1(c1rfpo(r,f),1), f) + throughput_sc(1);
        throughput_sc(2) = sum(throughput_sc_2(:))/12; % subcarrier数で正規化
        cumulative_throughput_pro(UC1(c1rfpo(r,f),2), f) = cumulative_throughput_pro(UC1(c1rfpo(r,f),2), f) + throughput_sc(2);
        throughput_sc(3) = sum(throughput_sc_3(:))/12; % subcarrier数で正規化
...
cumulative_throughput_utp(UC1(c1rfpo(r,f),1),trial) = cumulative_throughput_utp(UC1(c1rfpo(r,f),1),trial) + ...
log2( 1 + power_uuk_all(UC1(c1rfpo(r,f),1),UC1(c1rfpo(r,f),1),N_subcar_1RB*(r-1)+k)/(power_uuk_all(UC1(c1rfpo(r,f),1),UC1(c1rfpo(r,f),2),N_subcar_1RB*(r-1)+k)...
+ power_uuk_all(UC1(c1rfpo(r,f),1),user2po,N_subcar_1RB*(r-1)+k) + Npw) );
          
cumulative_throughput_utp(UC1(c1rfpo(r,f),2),trial) = cumulative_throughput_utp(UC1(c1rfpo(r,f),2),trial) + ...
log2( 1 + power_uuk_all(UC1(c1rfpo(r,f),2),UC1(c1rfpo(r,f),2),N_subcar_1RB*(r-1)+k)/(power_uuk_all(UC1(c1rfpo(r,f),2),UC1(c1rfpo(r,f),1),N_subcar_1RB*(r-1)+k)...
+ power_uuk_all(UC1(c1rfpo(r,f),2),user2po,N_subcar_1RB*(r-1)+k) + Npw) );

cumulative_throughput_utp(user2po,trial) = cumulative_throughput_utp(user2po,trial) + ...
log2( 1 + power_uuk_all(user2po,user2po,N_subcar_1RB*(r-1)+k)/(power_uuk_all(user2po,UC1(c1rfpo(r,f),1),N_subcar_1RB*(r-1)+k) + power_uuk_all(user2po,UC1(c1rfpo(r,f),2),N_subcar_1RB*(r-1)+k) + Npw) );
...
log2( 1 + power_uuk_all(user2po,user2po,N_subcar_1RB*(r-1)+k)/(power_uuk_all(user2po,UC1(c1rfpo(r,f),1),N_subcar_1RB*(r-1)+k) + power_uuk_all(user2po,UC1(c1rfpo(r,f),2),N_subcar_1RB*(r-1)+k) + Npw) );
        ...
        %% 実際の値
        [throughput_sc_1,throughput_sc_2,throughput_sc_3] = calculate_throughput_3user(power_uuk_all, noise_variance_dBm, r, UC1(c1rfpo(r,f),1), UC1(c1rfpo(r,f),2), user2po);
        ...
        % 累積スループット値（1subcarrierあたりに正規化している）
            ...
            for k = 1:N_subcar_1RB
cumulative_throughput_utp(UC1(c1rfpo(r,f),1),trial) = cumulative_throughput_utp(UC1(c1rfpo(r,f),1),trial) + ...
log2( 1 + power_uuk_all(UC1(c1rfpo(r,f),1),UC1(c1rfpo(r,f),1),N_subcar_1RB*(r-1)+k)/Npw );

cumulative_throughput_utp(UC1(c1rfpo(r,f),2),trial) = cumulative_throughput_utp(UC1(c1rfpo(r,f),2),trial) + ...
log2( 1 + power_uuk_all(UC1(c1rfpo(r,f),2),UC1(c1rfpo(r,f),2),N_subcar_1RB*(r-1)+k)/Npw );
...
log2( 1 + power_uuk_all(UC1(c1rfpo(r,f),2),UC1(c1rfpo(r,f),2),N_subcar_1RB*(r-1)+k)/Npw );
        ...
        [throughput_sc_1,throughput_sc_2] = calculate_throughput_PF(power_uuk1, noise_variance_dBm, r, c1rfpo(r,f), combnk(1:Nu_TP1,Nu_1RB));
...
log2( 1 + power_uuk_all(UC1pe(c1rfpe(r,f),1),UC1pe(c1rfpe(r,f),1),N_subcar_1RB*(r-1)+k)/(power_uuk_all(UC1pe(c1rfpe(r,f),1),UC1pe(c1rfpe(r,f),2),N_subcar_1RB*(r-1)+k)...
+ power_uuk_all(UC1pe(c1rfpe(r,f),1),UC2(c2rfpe(r,f),1),N_subcar_1RB*(r-1)+k) + power_uuk_all(UC1pe(c1rfpe(r,f),1),UC2(c2rfpe(r,f),2),N_subcar_1RB*(r-1)+k) + Npw) );
          
cumulative_throughput_utp(UC1pe(c1rfpe(r,f),2),trial) = cumulative_throughput_utp(UC1pe(c1rfpe(r,f),2),trial) + ...
log2( 1 + power_uuk_all(UC1pe(c1rfpe(r,f),2),UC1pe(c1rfpe(r,f),2),N_subcar_1RB*(r-1)+k)/(power_uuk_all(UC1pe(c1rfpe(r,f),2),UC1pe(c1rfpe(r,f),1),N_subcar_1RB*(r-1)+k)...
+ power_uuk_all(UC1pe(c1rfpe(r,f),2),UC2(c2rfpe(r,f),1),N_subcar_1RB*(r-1)+k) + power_uuk_all(UC1pe(c1rfpe(r,f),2),UC2(c2rfpe(r,f),2),N_subcar_1RB*(r-1)+k) + Npw) );

cumulative_throughput_utp(UC2(c2rfpe(r,f),1),trial) = cumulative_throughput_utp(UC2(c2rfpe(r,f),1),trial) + ...
log2( 1 + power_uuk_all(UC2(c2rfpe(r,f),1),UC2(c2rfpe(r,f),1),N_subcar_1RB*(r-1)+k)/(power_uuk_all(UC2(c2rfpe(r,f),1),UC2(c2rfpe(r,f),2),N_subcar_1RB*(r-1)+k)...
+ power_uuk_all(UC2(c2rfpe(r,f),1),UC1pe(c1rfpe(r,f),1),N_subcar_1RB*(r-1)+k) + power_uuk_all(UC2(c2rfpe(r,f),1),UC1pe(c1rfpe(r,f),2),N_subcar_1RB*(r-1)+k) + Npw) );
          
cumulative_throughput_utp(UC2(c2rfpe(r,f),2),trial) = cumulative_throughput_utp(UC2(c2rfpe(r,f),2),trial) + ...
log2( 1 + power_uuk_all(UC2(c2rfpe(r,f),2),UC2(c2rfpe(r,f),2),N_subcar_1RB*(r-1)+k)/(power_uuk_all(UC2(c2rfpe(r,f),2),UC2(c2rfpe(r,f),1),N_subcar_1RB*(r-1)+k)...
+ power_uuk_all(UC2(c2rfpe(r,f),2),UC1pe(c1rfpe(r,f),1),N_subcar_1RB*(r-1)+k) + power_uuk_all(UC2(c2rfpe(r,f),2),UC1pe(c1rfpe(r,f),2),N_subcar_1RB*(r-1)+k) + Npw) );
...
cumulative_throughput_atp(u2a(UC2(c2rfpe(r,f),1)),trial) = cumulative_throughput_atp(u2a(UC2(c2rfpe(r,f),1)),trial) + ...
log2( 1 + power_uuk_all(UC2(c2rfpe(r,f),1),UC2(c2rfpe(r,f),1),N_subcar_1RB*(r-1)+k)/(power_uuk_all(UC2(c2rfpe(r,f),1),UC2(c2rfpe(r,f),2),N_subcar_1RB*(r-1)+k)...
+ power_uuk_all(UC2(c2rfpe(r,f),1),UC1pe(c1rfpe(r,f),1),N_subcar_1RB*(r-1)+k) + power_uuk_all(UC2(c2rfpe(r,f),1),UC1pe(c1rfpe(r,f),2),N_subcar_1RB*(r-1)+k) + Npw) );
          
cumulative_throughput_atp(u2a(UC2(c2rfpe(r,f),2)),trial) = cumulative_throughput_atp(u2a(UC2(c2rfpe(r,f),2)),trial) + ...
log2( 1 + power_uuk_all(UC2(c2rfpe(r,f),2),UC2(c2rfpe(r,f),2),N_subcar_1RB*(r-1)+k)/(power_uuk_all(UC2(c2rfpe(r,f),2),UC2(c2rfpe(r,f),1),N_subcar_1RB*(r-1)+k)...
+ power_uuk_all(UC2(c2rfpe(r,f),2),UC1pe(c1rfpe(r,f),1),N_subcar_1RB*(r-1)+k) + power_uuk_all(UC2(c2rfpe(r,f),2),UC1pe(c1rfpe(r,f),2),N_subcar_1RB*(r-1)+k) + Npw) );
            end
...
%% 実際の値
        [throughput_sc_1,throughput_sc_2,throughput_sc_3,throughput_sc_4] = calculate_throughput_4user(power_uuk_all, noise_variance_dBm, r, UC1pe(c1rfpe(r,f),1),UC1pe(c1rfpe(r,f),2),UC2(c2rfpe(r,f),1),UC2(c2rfpe(r,f),2));
        ...
        throughput_sc(3) = sum(throughput_sc_3(:))/12; % subcarrier数で正規化
        cumulative_throughput_pro(UC2(c2rfpe(r,f),1), f) = cumulative_throughput_pro(UC2(c2rfpe(r,f),1), f) + throughput_sc(3);
        throughput_sc(4) = sum(throughput_sc_4(:))/12; % subcarrier数で正規化
        cumulative_throughput_pro(UC2(c2rfpe(r,f),2), f) = cumulative_throughput_pro(UC2(c2rfpe(r,f),2), f) + throughput_sc(4);
        
        
        elseif N_1pe == 1
            for k = 1:N_subcar_1RB
cumulative_throughput_utp(user1pe,trial) = cumulative_throughput_utp(user1pe,trial) + ...
log2( 1 + power_uuk_all(user1pe,user1pe,N_subcar_1RB*(r-1)+k)/(power_uuk_all(user1pe,UC2(c2rfpe(r,f),1),N_subcar_1RB*(r-1)+k) + power_uuk_all(user1pe,UC2(c2rfpe(r,f),2),N_subcar_1RB*(r-1)+k) + Npw) );

cumulative_throughput_utp(UC2(c2rfpe(r,f),1),trial) = cumulative_throughput_utp(UC2(c2rfpe(r,f),1),trial) + ...
log2( 1 + power_uuk_all(UC2(c2rfpe(r,f),1),UC2(c2rfpe(r,f),1),N_subcar_1RB*(r-1)+k)/(power_uuk_all(UC2(c2rfpe(r,f),1),UC2(c2rfpe(r,f),2),N_subcar_1RB*(r-1)+k)...
+ power_uuk_all(UC2(c2rfpe(r,f),1),user1pe,N_subcar_1RB*(r-1)+k) + Npw) );
          
cumulative_throughput_utp(UC2(c2rfpe(r,f),2),trial) = cumulative_throughput_utp(UC2(c2rfpe(r,f),2),trial) + ...
log2( 1 + power_uuk_all(UC2(c2rfpe(r,f),2),UC2(c2rfpe(r,f),2),N_subcar_1RB*(r-1)+k)/(power_uuk_all(UC2(c2rfpe(r,f),2),UC2(c2rfpe(r,f),1),N_subcar_1RB*(r-1)+k)...
+ power_uuk_all(UC2(c2rfpe(r,f),2),user1pe,N_subcar_1RB*(r-1)+k) + Npw) );
...
+ power_uuk_all(UC2(c2rfpe(r,f),2),user1pe,N_subcar_1RB*(r-1)+k) + Npw) );
        ...
        %% 実際の値
        [throughput_sc_1,throughput_sc_2,throughput_sc_3] = calculate_throughput_3user(power_uuk_all, noise_variance_dBm, r, UC2(c2rfpe(r,f),1), UC2(c2rfpe(r,f),2), user1pe);
        
        throughput_sc = zeros(1,3);   % 瞬時スループットに相当する
        
        throughput_sc(1) = sum(throughput_sc_1(:))/12; % subcarrier数で正規化
        cumulative_throughput_pro(UC2(c2rfpe(r,f),1), f) = cumulative_throughput_pro(UC2(c2rfpe(r,f),1), f) + throughput_sc(1);
        throughput_sc(2) = sum(throughput_sc_2(:))/12; % subcarrier数で正規化
        cumulative_throughput_pro(UC2(c2rfpe(r,f),2), f) = cumulative_throughput_pro(UC2(c2rfpe(r,f),2), f) + throughput_sc(2);
        throughput_sc(3) = sum(throughput_sc_3(:))/12; % subcarrier数で正規化
        ...
        % 累積スループット値（1subcarrierあたりに正規化している）
            ...
            for k = 1:N_subcar_1RB
cumulative_throughput_utp(UC2(c2rfpe(r,f),1),trial) = cumulative_throughput_utp(UC2(c2rfpe(r,f),1),trial) + ...
log2( 1 + power_uuk_all(UC2(c2rfpe(r,f),1),UC2(c2rfpe(r,f),1),N_subcar_1RB*(r-1)+k)/Npw );

cumulative_throughput_utp(UC2(c2rfpe(r,f),2),trial) = cumulative_throughput_utp(UC2(c2rfpe(r,f),2),trial) + ...
log2( 1 + power_uuk_all(UC2(c2rfpe(r,f),2),UC2(c2rfpe(r,f),2),N_subcar_1RB*(r-1)+k)/Npw );
...
log2( 1 + power_uuk_all(UC2(c2rfpe(r,f),2),UC2(c2rfpe(r,f),2),N_subcar_1RB*(r-1)+k)/Npw );
        ...
        [throughput_sc_1,throughput_sc_2] = calculate_throughput_PF(power_uuk2, noise_variance_dBm, r, c2rfpe(r,f), combnk(1:Nu_TP2,Nu_1RB));
