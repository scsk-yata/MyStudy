...
file_name = ['Result_',num2str(N_area),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_unihor'];
save( [file_name,'/cumulative_throughput_',num2str(trial),'trial'] , 'cumulative_throughput', 'cumulative_throughput_con','cumulative_throughput_pro', 'cumulative_throughput_I0', 'cumulative_throughput_con_I0', 'cumulative_throughput_pro_I0','a2aps','a2apsc','a2apsp','area_user')

if trial == N_trial
save( [file_name,'/cumulative_throughput_',num2str(trial),'trial'] , 'cumulative_throughput', 'cumulative_throughput_con','cumulative_throughput_pro', 'cumulative_throughput_I0', 'cumulative_throughput_con_I0', 'cumulative_throughput_pro_I0','total_comb','total_comb_con','total_comb_pro','a2aps','a2apsc','a2apsp','area_user' ...
