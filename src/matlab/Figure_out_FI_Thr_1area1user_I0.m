...
for tr = 1:N_trial
    ...
    load( ['Result_',num2str(N_area_1TP),num2str(N_area_1TP),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial'...
        '/Workspace_Data_',num2str(tr),'trial'] , 'cumulative_throughput_I0' )
        %}
...
for tr = 1:N_trial
    ...
    %}
    load( ['Result_',num2str(N_area_1TP),num2str(N_area_1TP),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial'...
        '/Workspace_Data_',num2str(tr),'trial'] , 'cumulative_throughput_con_I0' )
        %}
...
for tr = 1:N_trial
    ...
    load( ['Result_44_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial'...
        '/Workspace_Data_',num2str(tr),'trial'] , 'cumulative_throughput_pro_I0','a2aps','a2apsc','a2apsp' )
        %}
        N_subframe = length(cumulative_throughput_pro_I0);
        
    PSA2A4 = PSA2A4 + a2aps;
    PSA2Ac4 = PSA2Ac4 + a2apsc;
    PSA2Ap4 = PSA2Ap4 + a2apsp;
...
for tr = 1:N_trial
    ...
    PSA2A8 = PSA2A8 + a2aps;
    PSA2Ac8 = PSA2Ac8 + a2apsc;
    PSA2Ap8 = PSA2Ap8 + a2apsp;
...
for tr = 1:N_trial
    ...
    PSA2A12 = PSA2A12 + a2aps;
    PSA2Ac12 = PSA2Ac12 + a2apsc;
    PSA2Ap12 = PSA2Ap12 + a2apsp;
...
for tr = 1:N_trial
    ...
    PSA2A16 = PSA2A16 + a2aps;
    PSA2Ac16 = PSA2Ac16 + a2apsc;
    PSA2Ap16 = PSA2Ap16 + a2apsp;
