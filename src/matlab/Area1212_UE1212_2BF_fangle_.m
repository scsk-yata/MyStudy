...
file_name = ['Result_',num2str(N_area),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_famngle'];
%{
...
%}
save( [file_name,'/Dataf12_',num2str(trial),'trial'],'cumulative_throughput','cumulative_throughput_con','cumulative_throughput_pro')
if trial == N_trial
save( [file_name,'/Dataf12_',num2str(trial),'trial'],'cumulative_throughput','cumulative_throughput_con','cumulative_throughput_pro'...
    ,'cumulative_throughput_ut','cumulative_throughput_utc','cumulative_throughput_utp','total_comb','total_comb_con','total_comb_pro')
end
