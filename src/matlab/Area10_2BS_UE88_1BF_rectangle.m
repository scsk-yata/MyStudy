%% ２基地局平行設置 20-88-1 allocationで一様にユーザを分布させた場合　送信範囲四角形の場合
clear
clc
rng('shuffle');
...
save( [file_name,'/cumulative_throughput_',num2str(trial+1000),'trial'] , 'cumulative_throughput', 'cumulative_throughput_con','cumulative_throughput_pro','total_comb','total_comb_con','total_comb_pro','mua1','mua2','nua' )
