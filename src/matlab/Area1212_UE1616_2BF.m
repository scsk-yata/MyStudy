...
%
save( [file_name,'/Data1_',num2str(trial),'trial'],'AC1','AC2','area_user','c1rf','c1rfce','c1rfco','c1rfp','c2rf','c2rfce','c2rfco','c2rfp'...
...
save( [file_name,'/Data1_',num2str(trial),'trial'],'cumulative_throughput','cumulative_throughput_con','cumulative_throughput_pro')
if trial == N_trial
save( [file_name,'/Data1_',num2str(trial),'trial'],'cumulative_throughput','cumulative_throughput_con','cumulative_throughput_pro','total_comb','total_comb_con','total_comb_pro')
end
%}
