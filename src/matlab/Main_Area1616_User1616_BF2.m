...
%{
ca1 = [3,18,32,45,57,68,78,87,95,102,108,113,117,13,28,42];
carf1 = ones(N_RB,1) * ca1;
carf1 = repmat(carf1,1,16);

ca2 = [3,18,32,45,57,68,78,87,95,102,108,113,117,13,28,42];
carf2 = ones(N_RB,1) * [ca2,circshift(ca2,1),circshift(ca2,2),circshift(ca2,3),circshift(ca2,4),circshift(ca2,5)...
    ...
    ,circshift(ca2,12),circshift(ca2,13),circshift(ca2,14),circshift(ca2,15)];
...
%{
ca1 = [4,19,33,46,58,69,79,88,96,103,109,114,12,27,41,54];
carf1 = ones(N_RB,1) * ca1;
carf1 = repmat(carf1,1,24);

ca2 = [4,19,33,46,58,69,79,88,96,103,109,114,12,27,41,54];
carf2 = ones(N_RB,1) * [ca2,circshift(ca2,1),circshift(ca2,2),circshift(ca2,3),circshift(ca2,4),circshift(ca2,5)...
    ,circshift(ca2,6),circshift(ca2,7),circshift(ca2,8),circshift(ca2,9),circshift(ca2,10),circshift(ca2,11)...
    ,circshift(ca2,12),circshift(ca2,13),circshift(ca2,14),circshift(ca2,15)];
...
%{
ca1 = [5,20,34,47,59,70,80,89,97,104,110,11,26,40,53,65];
carf1 = ones(N_RB,1) * ca1;
carf1 = repmat(carf1,1,24);

ca2 = [5,20,34,47,59,70,80,89,97,104,110,11,26,40,53,65];
carf2 = ones(N_RB,1) * [ca2,circshift(ca2,1),circshift(ca2,2),circshift(ca2,3),circshift(ca2,4),circshift(ca2,5)...
    ,circshift(ca2,6),circshift(ca2,7),circshift(ca2,8),circshift(ca2,9),circshift(ca2,10),circshift(ca2,11)...
    ,circshift(ca2,12),circshift(ca2,13),circshift(ca2,14),circshift(ca2,15)];
...
% Average Angular Separationを60度とする場合はこちらに切り替える
%{ 
ca1 = [6,21,35,48,60,71,81,90,98,105,10,25,39,52,64,75,5,20,34,47,59,70,80,89,97,104,110,11,26,40,53,65];
carf1 = ones(N_RB,1) * ca1;
...
carf2 = ones(N_RB,1) * [ca2,circshift(ca2,1),circshift(ca2,2),circshift(ca2,3),circshift(ca2,4),circshift(ca2,5)...
    ...
    ,circshift(ca2,18),circshift(ca2,19),circshift(ca2,20),circshift(ca2,21),circshift(ca2,22),circshift(ca2,23),circshift(ca2,24)...
    ,circshift(ca2,25),circshift(ca2,26),circshift(ca2,27),circshift(ca2,28),circshift(ca2,29),circshift(ca2,30),circshift(ca2,31)];
...
%
ca1 = [7,22,36,49,61,72,82,91,99,9,24,38,51,63,74,84,8,23,37,50,62,73,83,92];
carf1 = ones(N_RB,1) * ca1;
carf1 = repmat(carf1,1,24);

ca2 = [7,22,36,49,61,72,82,91,99,9,24,38,51,63,74,84,8,23,37,50,62,73,83,92];
carf2 = ones(N_RB,1) * [ca2,circshift(ca2,1),circshift(ca2,2),circshift(ca2,3),circshift(ca2,4),circshift(ca2,5)...
    ,circshift(ca2,6),circshift(ca2,7),circshift(ca2,8),circshift(ca2,9),circshift(ca2,10),circshift(ca2,11)...
    ,circshift(ca2,12),circshift(ca2,13),circshift(ca2,14),circshift(ca2,15),circshift(ca2,16),circshift(ca2,17)...
    ,circshift(ca2,18),circshift(ca2,19),circshift(ca2,20),circshift(ca2,21),circshift(ca2,22),circshift(ca2,23)];
...
for trial = 1:N_trial
%% 各受信端末の基地局から見た方位角と距離
load(['User_Distribution_Channel/Distribution_Channel_',num2str(trial),'trial.mat'] ,'d_tu','hor_tu','PL_dB_tu','H_1uak','H_2uak' )

d_tu = horzcat(d_tu(:,1:Nu_TP1),d_tu(:,(16+1):(16+Nu_TP2)));
hor_tu = horzcat(hor_tu(:,1:Nu_TP1),hor_tu(:,(16+1):(16+Nu_TP2)));
...
PL_dB_tu = horzcat(PL_dB_tu(:,1:Nu_TP1),PL_dB_tu(:,(16+1):(16+Nu_TP2)));
...
if P_LOS > rand
    ...
    PL_dB_tu(t,u) = 22.4 + 35.3*log10(sqrt(d_tu(t,u)^2+10^2)) + 21.3*log10(fc/(10^9));
end
...
%% 希望信号電力と干渉信号電力
    ...
    R_signal125 = sum( (reshape(H_1uak(25,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal225 = sum( (reshape(H_2uak(25,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal126 = sum( (reshape(H_1uak(26,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal226 = sum( (reshape(H_2uak(26,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal127 = sum( (reshape(H_1uak(27,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal227 = sum( (reshape(H_2uak(27,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal128 = sum( (reshape(H_1uak(28,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal228 = sum( (reshape(H_2uak(28,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal129 = sum( (reshape(H_1uak(29,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal229 = sum( (reshape(H_2uak(29,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal130 = sum( (reshape(H_1uak(30,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal230 = sum( (reshape(H_2uak(30,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    
    R_signal131 = sum( (reshape(H_1uak(31,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal231 = sum( (reshape(H_2uak(31,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal132 = sum( (reshape(H_1uak(32,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal232 = sum( (reshape(H_2uak(32,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    %{
...
% 従来手法の使用ビームエリア切り替えスケジューリング用の電力の箱を別で用意
if ~isempty(left_user1)
...
file_name = ['Result_',num2str(N_area_1TP),num2str(N_area_1TP),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial'];
%{
save( [file_name,'/Workspace_Data_',num2str(trial),'trial_narrow'],'area_user','cumulative_throughput','cumulative_throughput_con','cumulative_throughput_pro'...
...
%}
save( [file_name,'/Workspace_Data_',num2str(trial),'trial'],'area_user','cumulative_throughput','cumulative_throughput_con','cumulative_throughput_pro'...
    ,'a2aps','a2apsc','a2apsp','cumulative_throughput_i0','cumulative_throughput_con_i0','cumulative_throughput_pro_i0','cumulative_throughput_o0','cumulative_throughput_con_o0','cumulative_throughput_pro_o0')
if trial == N_trial
    save( [file_name,'/Workspace_Data_',num2str(trial),'trial'],'area_user','cumulative_throughput','cumulative_throughput_con','cumulative_throughput_pro'...
        ,'total_comb','cumulative_throughput_ut','cumulative_throughput_utc','cumulative_throughput_utp','total_comb_con','total_comb_pro','a2aps','a2apsc','a2apsp'...
