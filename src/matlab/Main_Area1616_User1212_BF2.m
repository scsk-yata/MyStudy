...
%% 希望信号電力と干渉信号電力
    ...
    R_signal113 = sum( (reshape(H_1uak(17,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal213 = sum( (reshape(H_2uak(17,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal114 = sum( (reshape(H_1uak(18,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal214 = sum( (reshape(H_2uak(18,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal115 = sum( (reshape(H_1uak(19,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal215 = sum( (reshape(H_2uak(19,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal116 = sum( (reshape(H_1uak(20,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal216 = sum( (reshape(H_2uak(20,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal117 = sum( (reshape(H_1uak(21,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal217 = sum( (reshape(H_2uak(21,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal118 = sum( (reshape(H_1uak(22,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal218 = sum( (reshape(H_2uak(22,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal119 = sum( (reshape(H_1uak(23,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal219 = sum( (reshape(H_2uak(23,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal120 = sum( (reshape(H_1uak(24,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal220 = sum( (reshape(H_2uak(24,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal121 = sum( (reshape(H_1uak(25,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal221 = sum( (reshape(H_2uak(25,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal122 = sum( (reshape(H_1uak(26,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal222 = sum( (reshape(H_2uak(26,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal123 = sum( (reshape(H_1uak(27,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal223 = sum( (reshape(H_2uak(27,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal124 = sum( (reshape(H_1uak(28,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
    R_signal224 = sum( (reshape(H_2uak(28,:,k),N_hor*N_ver,1)*ones(1,N_beam)) .*W .*Amp_ak ,1 );
