...
for tr = 1:N_trial
    ...
    %
    load( ['Result_16_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_CDL-D'...
        '/Data1_',num2str(tr),'trial'] , 'cumulative_throughput_pro')
    %{
...
Fairness_Index_proposed_8_narrow1 = sum(FI(:)) / N_trial;
Throughput_proposed_8_narrow1 = sum(Throughput_temp(:)) / N_trial;
...
for tr = 1:N_trial
    ...
    %
    load( ['Result_16_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_CDL-D'...
        '/Data2_',num2str(tr),'trial'] , 'cumulative_throughput_pro')
    %{
    load( ['Result_16_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_AWGN'...
        '/cumulative_throughput_',num2str(tr),'trial'] , 'cumulative_throughput_pro','total_comb_pro','nua','mua1','mua2' )
        %}
...
Fairness_Index_proposed_8_narrow2 = sum(FI(:)) / N_trial;
Throughput_proposed_8_narrow2 = sum(Throughput_temp(:)) / N_trial;
...
for tr = 1:N_trial
    ...
    %
    load( ['Result_24_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_CDL-D'...
        '/Data4_',num2str(tr),'trial'] , 'cumulative_throughput_pro' )
    %{
...
for tr = 1:N_trial
    ...
    %
    load( ['Result_24_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_CDL-D'...
        '/Data3_',num2str(tr),'trial'] , 'cumulative_throughput_pro')
    %{
    load( ['Result_32_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_AWGN'...
        '/cumulative_throughput_',num2str(tr),'trial'] , 'cumulative_throughput_pro','total_comb_pro','nua','mua1','mua2' )
        %}
...
Fairness_Index_proposed_12_narrow2 = sum(FI(:)) / N_trial;
Throughput_proposed_12_narrow2 = sum(Throughput_temp(:)) / N_trial;
...
%% グラフにプロット
    ...
    hold on
    plot(Fairness_Index_proposed_8_narrow2, Throughput_proposed_8_narrow2,'x','Linewidth',3,'MarkerSize',20)
    hold on
    plot(Fairness_Index_proposed_8_narrow1, Throughput_proposed_8_narrow1,'x','Linewidth',3,'MarkerSize',20)
    hold on
    ...
    hold on
    plot(Fairness_Index_proposed_12_narrow2, Throughput_proposed_12_narrow2,'x','Linewidth',3,'MarkerSize',20)
    hold on
   ...
   legend({'比較手法','従来手法','提案手法（分割エリア数８, 1,4スタート）','提案手法（分割エリア数８,1,3スタート）','提案手法（分割エリア数８,1,2スタート）','提案手法（分割エリア数１２,1,6スタート）','提案手法（分割エリア数１２,1,5スタート）','提案手法（分割エリア数１２,1,4スタート）','提案手法（分割エリア数１２,1,2スタート）'},'Location','northwest','FontSize',20)
