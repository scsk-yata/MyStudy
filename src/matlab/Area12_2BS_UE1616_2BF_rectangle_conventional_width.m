...
% 提案法のためのユーザ分け
user1pe = find(hor_1all < area_boundary(6));
user2po = find(hor_2all > area_boundary(8));
...
%file_name = ['Result_',num2str(N_area),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_fan2'];
file_name = ['Result_',num2str(N_area),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_fan-1_AWGN'];
