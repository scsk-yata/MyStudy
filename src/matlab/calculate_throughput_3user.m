function [ throughput_sc_1, throughput_sc_2, throughput_sc_3] = calculate_throughput_3user( power_uuk, noise_variance_dBm, r, u1 ,u2 ,u3 )
...
for sc = 1:N_subcarrier
    ...
    Interference1 = power_uuk(u1, u2, (r-1) * 12 + sc) + power_uuk(u1, u3, (r-1) * 12 + sc);
    Interference2 = power_uuk(u2, u1, (r-1) * 12 + sc) + power_uuk(u2, u3, (r-1) * 12 + sc);
    Interference3 = power_uuk(u3, u1, (r-1) * 12 + sc) + power_uuk(u3, u2, (r-1) * 12 + sc);
