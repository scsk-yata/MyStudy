%% ２基地局平行設置 12-1616-1 allocationで一様にユーザを分布させた場合　送信範囲四角形の場合
clear
clc
rng('shuffle');
...
area_boundary = [0,atand(4/N_area_1TP),90-atand(4/N_area_1TP),90,90+atand(4/N_area_1TP),180-atand(4/N_area_1TP),180];
...
carf = ones(N_RB,1) * [1 8 15 22 29 36 2 9 16 23 30 31 3 10 17 24 25 32 4 11 18 19 26 33 5 12 13 20 27 34 6 7 14 21 28 35];
carf = repmat(carf,1,5);
