...
% 組み合わせのインデックス
%{
ca1 = [2,13,23,32,40,47,53,58,62,65,10,21];
carf1 = ones(N_RB,1) * ca1;
carf1 = repmat(carf1,1,24);

ca2 = [5,16,26,35,43,50,56,7,18,28,37,45];
...
ca2 = [2,13,23,32,40,47,53,58,62,65,10,21];
carf2 = ones(N_RB,1) * [ca2,circshift(ca2,1),circshift(ca2,2),circshift(ca2,3),circshift(ca2,4),circshift(ca2,5),circshift(ca2,6),circshift(ca2,7),circshift(ca2,8),circshift(ca2,9),circshift(ca2,10),circshift(ca2,11)];
carf2 = repmat(carf2,1,2);
...
% 割り当てる2エリアの間隔を狭めた場合
%{
ca1 = [4,15,25,34,42,49,55,60,64,8,19,29,3,14,24,33,41,48,54,59,63,9,20,30];
carf1 = ones(N_RB,1) * ca1;
carf1 = repmat(carf1,1,24);

ca2 = ca1;
carf2 = ones(N_RB,1) * [ca2,circshift(ca2,1),circshift(ca2,2),circshift(ca2,3),circshift(ca2,4),circshift(ca2,5),circshift(ca2,6),circshift(ca2,7),circshift(ca2,8),circshift(ca2,9),circshift(ca2,10),circshift(ca2,11)...
    ,circshift(ca2,12),circshift(ca2,13),circshift(ca2,14),circshift(ca2,15),circshift(ca2,16),circshift(ca2,17),circshift(ca2,18),circshift(ca2,19),circshift(ca2,20),circshift(ca2,21),circshift(ca2,22),circshift(ca2,23)];
%carf2 = repmat(carf2,1,2);
