...
for tr = 1:N_trial
    ...
    %
    load( ['Result_',num2str(N_area_1TP),num2str(N_area_1TP),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_add'...
...
load( ['Result_',num2str(N_area_1TP),num2str(N_area_1TP),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_add'...
        '/All_Data_5000trial'] , 'cumulative_throughput_ut','total_comb' )

N_subframe = length(cumulative_throughput)
seq_ct_5000 = reshape(cumulative_throughput_ut,1,Nu_all*5000);
total_comb_5000 = total_comb;

load( ['Result_',num2str(N_area_1TP),num2str(N_area_1TP),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_add'...
        '/All_Data_10000trial'] , 'cumulative_throughput_ut','total_comb' )

N_subframe = length(cumulative_throughput)
seq_ct = horzcat(seq_ct_5000,reshape(cumulative_throughput_ut,1,Nu_all*5000));
total_comb = total_comb_5000 + total_comb;
...
load( ['Result_',num2str(N_area_1TP),num2str(N_area_1TP),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_add'...
        '/All_Data_5000trial'] , 'cumulative_throughput_utc','total_comb_con' )

N_subframe = length(cumulative_throughput_con)
seq_ct_5000 = reshape(cumulative_throughput_utc,1,Nu_all*5000);
total_comb_con_5000 = total_comb_con;

load( ['Result_',num2str(N_area_1TP),num2str(N_area_1TP),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_add'...
        '/All_Data_10000trial'] , 'cumulative_throughput_utc','total_comb_con' )

N_subframe = length(cumulative_throughput_con)
seq_ctc = horzcat(seq_ct_5000,reshape(cumulative_throughput_utc,1,Nu_all*5000));
total_comb_con = total_comb_con_5000 + total_comb_con;
...
for tr = 1:N_trial
    square_sum_temp = zeros(1, Nu_all);
    %
    load( ['Result_44_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_add'...
...
N_subframe = length(cumulative_throughput_pro)
seq_ct_5000 = reshape(cumulative_throughput_utp,1,Nu_all*5000);
total_comb_5000 = total_comb_pro;

load( ['Result_44_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_add'...
        '/All_Data_10000trial'] , 'cumulative_throughput_utp','total_comb_pro' )

N_subframe = length(cumulative_throughput_pro)
seq_ctp4 = horzcat(seq_ct_5000,reshape(cumulative_throughput_utp,1,Nu_all*5000));
total_comb_pro = total_comb_5000 + total_comb_pro;
...
for tr = 1:N_trial
    square_sum_temp = zeros(1, Nu_all);
    %
    load( ['Result_88_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_add'...
        '/All_Data_',num2str(tr),'trial'] , 'cumulative_throughput_pro')
    %{
...
N_subframe = length(cumulative_throughput_pro)
seq_ctp8 = horzcat(seq_ct_5000,reshape(cumulative_throughput_utp,1,Nu_all*5000));
total_comb_pro = total_comb_5000 + total_comb_pro;
...
for tr = 1:N_trial
    square_sum_temp = zeros(1, Nu_all);
    %
    load( ['Result_1212_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_add'...
        '/All_Data_',num2str(tr),'trial'] , 'cumulative_throughput_pro' )
    %{
...
N_subframe = length(cumulative_throughput_pro)
seq_ctp12 = horzcat(seq_ct_5000,reshape(cumulative_throughput_utp,1,Nu_all*5000));
total_comb_pro = total_comb_5000 + total_comb_pro;
...
for tr = 1:N_trial
    square_sum_temp = zeros(1, Nu_all);
    %
    load( ['Result_1616_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial_add'...
        '/All_Data_',num2str(tr),'trial'] , 'cumulative_throughput_pro' )
    %{
...
N_subframe = length(cumulative_throughput_pro)
seq_ctp16 = horzcat(seq_ct_5000,reshape(cumulative_throughput_utp,1,Nu_all*5000));
total_comb_pro = total_comb_5000 + total_comb_pro;
...
%%
save('Data_FI_Thr_Ncombi_CDF_data_8-2user')
