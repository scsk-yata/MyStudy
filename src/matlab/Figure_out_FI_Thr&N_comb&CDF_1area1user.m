%% FIvsスループット，候補組み合わせ数，Cumulative Throughput Function，1エリアあたりのユーザ数分布のグラフを作成する
...
CNT_Nu_1area_4 = zeros(1,(Nu_all/2)+1);
CNT_Nu_1area_8 = zeros(1,(Nu_all/2)+1);
CNT_Nu_1area_12 = zeros(1,(Nu_all/2)+1);
CNT_Nu_1area_16 = zeros(1,(Nu_all/2)+1);
...
load( ['Result_',num2str(N_area_1TP),num2str(N_area_1TP),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial'...
        '/Workspace_Data_',num2str(tr),'trial'] ,'total_comb' )
...
load( ['Result_',num2str(N_area_1TP),num2str(N_area_1TP),'_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial'...
        '/Workspace_Data_',num2str(tr),'trial'] ,'total_comb_con' )
...
for tr = 1:N_trial
    ...
    load( ['Result_44_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial'...
        '/Workspace_Data_',num2str(tr),'trial'] , 'cumulative_throughput_pro','area_user' )

    for ai = 1:4
        CNT_Nu_1area_4(nnz(area_user(ai,:))+1) = CNT_Nu_1area_4(nnz(area_user(ai,:))+1) + 1;
    end
...
load( ['Result_44_',num2str(Nu_TP1),num2str(Nu_TP2),'_',num2str(Nu_1RB),'_',num2str(N_trial),'trial'...
        '/Workspace_Data_',num2str(tr),'trial'] ,'cumulative_throughput_ut','cumulative_throughput_utc','cumulative_throughput_utp','total_comb_pro' )
...
legend({'比較手法','従来手法','提案手法（分割エリア数４）'},'Location','southeast','FontSize',12)
...
Probability_Nu_1area_4 = CNT_Nu_1area_4/sum(CNT_Nu_1area_4);
%}
...
for tr = 1:N_trial
    ...
    for ai = 1:8
        CNT_Nu_1area_8(nnz(area_user(ai,:))+1) = CNT_Nu_1area_8(nnz(area_user(ai,:))+1) + 1;
    end
        N_subframe = length(cumulative_throughput_pro);
...
legend({'比較手法','従来手法','提案手法（分割エリア数8）'},'Location','southeast','FontSize',12)
xlabel('Throughput/User/Trial','FontSize',20,'FontName','Arial')
ylabel('Probability','FontSize',20,'FontName','Arial')
...
Probability_Nu_1area_8 = CNT_Nu_1area_8/sum(CNT_Nu_1area_8);
...
for tr = 1:N_trial
    ...
    for ai = 1:12
        CNT_Nu_1area_12(nnz(area_user(ai,:))+1) = CNT_Nu_1area_12(nnz(area_user(ai,:))+1) + 1;
    end
        N_subframe = length(cumulative_throughput_pro);
...
legend({'比較手法','従来手法','提案手法（分割エリア数12）'},'Location','southeast','FontSize',12)
xlabel('Throughput/User/Trial','FontSize',20,'FontName','Arial')
ylabel('Probability','FontSize',20,'FontName','Arial')
...
Probability_Nu_1area_12 = CNT_Nu_1area_12/sum(CNT_Nu_1area_12);
...
for tr = 1:N_trial
    ...
    for ai = 1:16
        CNT_Nu_1area_16(nnz(area_user(ai,:))+1) = CNT_Nu_1area_16(nnz(area_user(ai,:))+1) + 1;
    end
        N_subframe = length(cumulative_throughput_pro);
...
legend({'比較手法','従来手法','提案手法（分割エリア数16）'},'Location','southeast','FontSize',12)
xlabel('Throughput/User/Trial','FontSize',20,'FontName','Arial')
ylabel('Probability','FontSize',20,'FontName','Arial')
...
Probability_Nu_1area_16 = CNT_Nu_1area_16/sum(CNT_Nu_1area_16);
...
legend({'PF scheduling','Conventional scheme','Proposed scheme (Number of Divided Areas : 4)','Proposed scheme (Number of Divided Areas : 8)'...
       ,'Proposed scheme (Number of Divided Areas : 12)','Proposed scheme (Number of Divided Areas : 16)'},'Location','southeast','FontSize',12)
...
%% グラフにプロット
   ...
   legend({'PF scheduling','Conventional scheme','Proposed scheme (Number of Divided Areas : 4)','Proposed scheme (Number of Divided Areas : 8)'...
       ,'Proposed scheme (Number of Divided Areas : 12)','Proposed scheme (Number of Divided Areas : 16)'},'Location','northwest','FontSize',20)
   %}
   ...
   figure
    ...
    %}
    xlabel('Number of the Divided Areas','FontSize',30,'FontName','Arial')
    ylabel('Number of User Combinations (/RB/Subframe/Trial/BS)','FontSize',30,'FontName','Arial')
    %}
    
    
    
    %% Probability of users per divided areas
figure
plot([0:round(Nu_all/2)],[Probability_Nu_1area_4],'+-','Linewidth',3,'MarkerSize',20)
hold on
plot([0:round(Nu_all/2)],[Probability_Nu_1area_8],'d-','Linewidth',3,'MarkerSize',20)
hold on
plot([0:round(Nu_all/2)],[Probability_Nu_1area_12],'>-','Linewidth',3,'MarkerSize',20)
hold on
plot([0:round(Nu_all/2)],[Probability_Nu_1area_16],'s-','Linewidth',3,'MarkerSize',20))

legend({'Number of Divided Areas : 4','Number of Divided Areas : 8'...
       ,'Number of Divided Areas : 12','Number of Divided Areas : 16'},'Location','southeast','FontSize',12)
xlabel('Number of Users per Divided Area','FontSize',20,'FontName','Arial')
ylabel('Probability','FontSize',20,'FontName','Arial')