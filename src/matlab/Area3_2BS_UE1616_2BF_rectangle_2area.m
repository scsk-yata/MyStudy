%% ２基地局平行設置 6-1616-2 allocationで一様にユーザを分布させた場合　送信範囲四角形の場合
clear
clc
rng('shuffle');
...
area_boundary = [0,90-atand(2/3),90+atand(2/3),180];
...
carf1 = repmat(carf1,1,192);

ca2 = [2,3,1];
carf2 = ones(N_RB,1) * [ca2,circshift(ca2,1),circshift(ca2,2)];
carf2 = repmat(carf2,1,96);
